                    ...
                    >
                        ...
                        <div className="relative group w-full max-w-[290px] sm:max-w-[330px] lg:max-w-[345px] flex justify-center">
                            ...
                            <motion.div
                                ...
                                className="absolute top-4 -right-16 sm:-right-14 px-3.5 py-2 rounded-2xl bg-[#091124]/95 border border-emerald-500/50 backdrop-blur-md shadow-[0_10px_25px_rgba(0,0,0,0.6)] flex items-center gap-2.5 z-20"
                            >
                            ...
                            <motion.div
                                ...
                                className="absolute bottom-14 -right-11 sm:-right-6 px-3.5 py-2 rounded-2xl bg-[#091124]/95 border border-cyan-500/50 backdrop-blur-md shadow-[0_10px_25px_rgba(0,0,0,0.6)] flex items-center gap-2.5 z-20"
                            >
                            ...
                            <motion.div
                                ...
                                className="absolute bottom-28 -left-11 sm:-left-14 px-3.5 py-2 rounded-2xl bg-[#091124]/95 border border-teal-500/50 backdrop-blur-md shadow-[0_10px_25px_rgba(0,0,0,0.6)] flex items-center gap-2 z-20"
                            >
